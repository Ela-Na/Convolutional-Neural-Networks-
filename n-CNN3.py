# -*- coding: utf-8 -*-
"""
Created on Wed Jul 29 11:31:38 2020
...
def train(train_loader, test_loader, model, optimizer, criterion):
    ...
    for epoch in range(num_epochs):
        ...
        CM = Plot_ConfMat.plot_confusion_matrix(lbl, pred, [i for i in range(10)],
                                           normalize=True,
                                           title="We Love IEEE",
                                           cmap=plt.cm.PuBu)#YlGn)
        writer.add_figure('Confusion Matrix', CM, epoch+1)
